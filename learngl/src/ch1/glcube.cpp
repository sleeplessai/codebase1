...
int main() {
    ...
    unsigned char* tex_data = stbi_load("assets/ch1/container.jpg", &width, &height, &channels, 0);
...
#include "../assets/ch1/cube.inc"
    ...
    Shader sp("shaders/ch1/glcube.vs", "shaders/ch1/glcube.fs");
